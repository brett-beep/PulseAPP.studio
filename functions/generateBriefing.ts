...
// NOTE: Base44 deploys each function independently — NO local imports allowed.
// staticEconomicCalendar.ts and briefingMemory.ts must be standalone HTTP functions.
